<div id="comments" <?php if( have_comments() ) :?>>
<!-- Comments -->
<div class="entry-comments mt-20">
                ...
                <div id="respond" class="comment-form mt-60">
                  ...
                  <form id="form" method="post" action="<?php echo get_stylesheet_directory_uri() . '/true-comments-post.php' ?>">
                    <div class="row row-16">
                      ...
                      <?php else :?>
                        ...
                        <?php endif; ?>
                      <div class="col-md-12">
                        <textarea name="real" id="comment" placeholder="Сообщение" rows="8" tabindex="9"></textarea>
                        <div style="display:none;">
                          <textarea name="comment" id="comment" placeholder="Сообщение" rows="8" tabindex="1"></textarea>
                        </div>
                      </div>
                    </div>
